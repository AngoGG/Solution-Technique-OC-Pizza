...
ALTER TABLE oc_pizza.user_order ADD CONSTRAINT user__user_order_fk
...
ALTER TABLE oc_pizza.user_order ADD CONSTRAINT user__user_order_fk1
FOREIGN KEY (preparator_id)
REFERENCES oc_pizza.user_ (id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
